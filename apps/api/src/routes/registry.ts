...
export const ROUTES: readonly RouteSpec[] = [
  ...
  },
  {
    ...
    state: "planned",
    willServe: "The identity of the committed gold build currently served.",
    milestone: M2,
    backedBy: "data/gold/_contracts/*.json",
  },
  {
    method: "GET",
    path: "/seasons",
    ...
    state: "planned",
    willServe: "The seasons present in gold, decoded from GAME_ID and asserted.",
    milestone: M2,
    backedBy: "services/ml/src/lineupiq/seasons.py SEASON_COVERAGE",
  },
  {
    method: "GET",
    path: "/zones",
    ...
    state: "planned",
    willServe: "The same zone definitions the model uses, so the chart is auditable.",
    milestone: M3,
    backedBy: "services/ml/src/lineupiq/configs/zones.json",
  },
  ...
  // -- players -------------------------------------------------------------
  {
    ...
    state: "planned",
    willServe: "Player id, name and seasons active.",
    milestone: M2,
    backedBy: "data/gold/dim_player.parquet",
  },
  {
    method: "GET",
